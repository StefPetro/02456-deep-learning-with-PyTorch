...
x, y, idx_to_region = prepare_data(pcs, meta, num_of_pcs=INPUT_SIZE, ancient_samples=False)
...
model_file = f'checkpoints\input_{INPUT_SIZE}/no_ancient_epoch=161_val_acc=0.00.ckpt'
...
ConfusionMatrixDisplay.from_predictions(
    ...
    normalize='true', 
    display_labels=np.array(list(idx_to_region.keys())),
...
plt.savefig('imgs/confusionmatrix_no_ancient.svg', bbox_inches='tight', pad_inches=0.1)
plt.show()
